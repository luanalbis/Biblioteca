...
public class EmailConfirmUtil {
    ...
    public static void enviarEmailConfirmacao(String destinatario,String nomeUsuario, String token) throws MessagingException {
        ...
        try {
            ...
            String conteudo = "Clique no link abaixo para confirmar seu cadastro:\n"
            		+"http://localhost:8080/Biblioteca/confirm?email=" 
