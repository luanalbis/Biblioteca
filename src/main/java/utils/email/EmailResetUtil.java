...
public class EmailResetUtil {

    public static void enviarEmailRedefinicao(String destinatario,String nomeUsuario, String token) throws MessagingException {
        ...
        try {
            ...
            String conteudo = "Clique no link abaixo para redefinir sua senha:\n\n"
            		+"http://localhost:8080/Biblioteca/redefine?email=" 
