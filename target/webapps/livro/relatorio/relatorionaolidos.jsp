...
ArrayList<NaoLidosRelatory> naoLidosRelatorio = (ArrayList<NaoLidosRelatory>) request.getAttribute("naoLidosRelatorio");
%>
<!DOCTYPE html>
<html lang="pt-br">
<head>
	...
	<table class="tabelaDetalhes">
		<div class="filtroWrapper">
			...
			<tbody>
				<%
				int numeracao = 1;
				for (NaoLidosRelatory l : naoLidosRelatorio) {
				%>
				<tr>
					<td><%=numeracao++%></td>
					<td><%=l.getLivro()%></td>
