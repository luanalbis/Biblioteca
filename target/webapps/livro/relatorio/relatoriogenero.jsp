...
ArrayList<GeneroRelatory> generoRelatorio = (ArrayList<GeneroRelatory>) request.getAttribute("generoRelatorio");
%>
<!DOCTYPE html>
<html lang="pt-br">
<head>
	...
	<table class="tabelaDetalhes">
		<div class="filtroWrapper">
			...
			<tbody>
				<%
				int numeracao = 1;
				for (GeneroRelatory g : generoRelatorio) {
				%>
				<tr>
					<td><%=numeracao++%></td>
					<td><%=g.getGenero()%></td>
					<td><%=g.getTotalLidos()%></td>
					<td><%=g.getTotal()%></td>
				</tr>
				<%
				}
